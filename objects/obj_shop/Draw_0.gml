...
draw_text_ext_transformed(x-70, y-46, shop_header+string(prerequesite),10,100, 0.5, 0.5, image_angle)
var desScale=0.45
draw_text_ext_transformed(x-6, y-27, shop_des,40*desScale,450*desScale,desScale, desScale, image_angle)

draw_text_ext_transformed(x-6, y+20, string("Coal: {0}\nIron: {1}\nWood: {2}",coal_price,iron_price,wood_price),20,200, 0.4, 0.4, image_angle)
